...
10. Success! You should see a gamepad preview that updates when a button is pressed.
       - Depending on the eample code provided, you can also verify that arduino is working by going to your IP address in a browser and publishing the expected commands to manually trigger a reaction from the ESP-32
